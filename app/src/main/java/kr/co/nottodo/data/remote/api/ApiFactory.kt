...
object ServicePool {
    ...
    val recommendationCategorySituationService =
        ApiFactory.create<RecommendationCategorySituationService>()
    val addSituationService = ApiFactory.create<AddSituationService>()
}